...
class HeteroGraphConv(nn.Module):
    ...
    def forward(self, graph: dgl.DGLHeteroGraph, input_src:dict, input_dst: dict, relation_embedding: dict,
                node_transformation_layers: nn.ModuleDict, relation_src_node_transformation_layers: nn.ModuleDict,
        ...
        for stype, etype, dtype in graph.canonical_etypes:
            ...
            dst_representation, dst_after_transformation = self.mods[etype](rel_graph,
                                                  ...
                                                  node_transformation_layers[stype],
                                                  node_transformation_layers[dtype],
