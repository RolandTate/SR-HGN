...
class RelationAttentionConv(nn.Module):
    ...
    def forward(self, graph: dgl.DGLHeteroGraph, feat: tuple, relation_src_node_transformation_layer: nn.Linear,
                relation_embedding: torch.Tensor, relation_transformation_weight: nn.Parameter):
        r"""
        ...
        # print(f'src before trans: {feat_src.shape}, dst before trans: {feat_dst.shape}, {src_node_transformation_layer}')
        # print(f'src after trans: {feat_src.shape}')
