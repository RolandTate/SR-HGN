...
from model_RHGNN.RelationGraphConv import RelationGraphConv
from model_RHGNN.HeteroConv import HeteroGraphConv
from model_RHGNN.RelationCrossing import RelationCrossing
from model_RHGNN.RelationFusing import RelationFusing
...
class R_HGNN(nn.Module):
    ...
    def forward(self, blocks, relation_embedding: dict = None):
        """
        ...
        with blocks.local_scope():
            relation_target_node_features = {(stype, etype, dtype): blocks.srcnodes[dtype].data['x'] for stype, etype, dtype in
                              blocks.canonical_etypes}
            ...
            for layer in self.layers:
                relation_target_node_features, relation_embedding = layer(blocks, relation_target_node_features,
                                                                          relation_embedding)
